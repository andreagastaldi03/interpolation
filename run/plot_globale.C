void plot_globale() {
    TCanvas *c_all = new TCanvas("c_all", "Panoramica Completa Radioterapia", 1000, 800);
    c_all->SetGrid();
    ...
    TGraph *g_kerma1    = new TGraph("profilo_dose_gk.dat", "%lg %*lg %lg %*lg %*lg %*lg %*lg");
    ...
    TGraph *g_dose_k    = new TGraph("profilo_dose_gk.dat", "%lg %*lg %*lg %*lg %lg %*lg %*lg");
    TGraph *g_dose_ktot = new TGraph("profilo_dose_gk.dat", "%lg %*lg %*lg %*lg %*lg %*lg %lg");
    TGraph *g_dose_ttot = new TGraph("profilo_dose_gk.dat", "%lg %*lg %*lg %*lg %*lg %*lg %*lg %lg");
    TGraph *g_dose_kten = new TGraph("profilo_dose_gk.dat", "%lg %*lg %*lg %*lg %*lg %*lg %*lg %*lg %lg");
